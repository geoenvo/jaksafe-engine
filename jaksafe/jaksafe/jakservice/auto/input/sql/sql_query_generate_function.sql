...
CREATE OR REPLACE FUNCTION auto_dala_json(event_id int)
  RETURNS TABLE (
	id text,
	kelurahan_id text,
	kota varchar(100),
...
BEGIN
   ...
   SELECT 
	...
	to_char(t1, 'yyyy-mm-dd hh:mm:ss') tanggal,
    ...
    GROUP BY a.id_event, a.kelurahan, a.kecamatan, a.kota, kelurahan_id, t1
